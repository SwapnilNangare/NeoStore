...
Log.e("sdjhj", product_images)
 ...
 imagemain=findViewById<ImageView>(R.id.viewimage_main) as ImageView
        ...
        ProductDetailsApiManager.instance.fetchUserdetail(id)
                       ...
                       // val rating: Float = wmbPreference1.getFloat("numStars", 0f)
                        ...
                        btnSubmit.setOnClickListener(object : View.OnClickListener {
                            override fun onClick(v: View?) {
                                ProductDetailsApiManager.instance.setRating(id, rateValue)
                        ...
                        btnSubmit.setOnClickListener(object : View.OnClickListener {
                            override fun onClick(v: View?) {
                                ...
                                if (value.isNotEmpty()) {
                                    ...
                                    ProductDetailsApiManager.instance.buynow(token, id, finalValue)
